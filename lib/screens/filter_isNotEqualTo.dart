// in this page both works are here that is Edit or Update and Delete with
...
class _UpdateDataPageState extends State<UpdateDataPage> {
  getData() async {
    ...
    try {
      // Agar Ham yaha .where() ki jaga .orderBy("name") likhege to jo
      // lists hogi wo alphabatical order matlb A to Z aygi .
      var result = await db
          .collection("Students")
          .where("name", isNotEqualTo: "Adnan")
          .get();
      return result;
    } catch (e) {
      print(e.toString());
